...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#faculty-sec"><img class="logo-custom" src="assets/img/logo.jpg" alt="logo"  /></a>
            </div>
           ...
           <li> <a href="#features-sec" class ="btn btn-primary"data-toggle="modal" data-target="#an"> <b>ADMIN</a></li>
 ...
 <div class="container">
     ...
     <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE EDGE Skateshop <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <!--HOME SECTION TAG LINE END-->   
         ...
         <div id="testimonials-sec" class="container set-pad bg-success" >
             <div class="row text-center">
          ...
          <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/c.jpg" style="width:100px;height:100px;" />
                   <h3>MAMAWGROUPS</h3>
                 <hr />
                      
                   <p >
                       This picture is one of the best memories they give us
					  on how to smile everyday.
                   </p>
				   </center>
           <BR>
               <a class="btn btn-primary btn-set"  >Team Mapadtamesak</a>
                </div>
                   </div>
				   ...
				   <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/d.jpg" style="width:100px;height:100px;" />
                   <h3 >MATULANGED </h3>
                 <hr />
				...
				<BR>
               <a class="btn btn-primary btn-set"  >Legendary Skateboarder</a>
                </div>
                   </div>
				    ...
				    <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center> 
                     <img class="img img-circle" src="assets/img/a.jpg" style="width:100px;height:100px;" />
                   <h3 >PUKIMON</h3>
                 <hr>
                       
                   <p >
                       The moto is to hardwork everyday to suntain daily life.
                   </p>
				   </center>
           <BR></BR>
               <a class="btn btn-primary btn-set"  >20120 Mga Tropang Puki </a>
                </div>
                   </div>
                 
				 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/b.jpg" style="width:100px;height:100px;" />
                   <h3 >RIDERS</h3>
                 <hr />
                    
                     <p>They run so fast and and team work.</p>

				   </center>
            <BR></BR>
               <a class="btn btn-primary btn-set"  >Drug Race 2013 Champion</a>
                </div>
                   </div>
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="assets/img/bong.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >Bong Salazar</h3>
                 <hr>
                         <h4>BSIT<br />DCLIS Department</h4>
                   <p>
                   Bong Salazar  ,is the designer of this site. 
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                       <img src="assets/img/1.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >Maria Dela Cruz</h3>
                 <hr>
                       <h4>BSIT<br />DCLIS Department</h4>
                   <p >
                   Maria Dela Cruz,is the developer of this site. 
					   She studied at Davao Oriental State College of Science and Technology (DOSCST) and taking up Bachelor of Science in Information Technology (BSIT). 
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div>
                        <h4>USM Kabacan,Cotabato City</h4>
                        <h4>Region XII,Philippines</h4>
						<h4>8200</h4>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2016 EDGE Skateshop| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : EDGE Team</a>
    </div>
     <!-- FOOTER SECTION END-->
